...
<%
    // Session check - දැනටමත් log වෙලා නම් dashboard එකට යවනවා
...
<div class="login-container">
    ...
    <%
        ...
        // පණිවිඩය 'invalid' නම් (Password වැරදුණු විට)
    ...
    // පණිවිඩය 'locked' නම් (Account එක Lock වූ විට)
...
<script type="text/javascript">
    // Back button එකෙන් ආපහු login එකට එන එක වළක්වයි
